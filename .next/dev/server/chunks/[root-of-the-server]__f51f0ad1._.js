...
"[project]/Documents/Project/smart.hiresapien.in/app/api/admin/institutions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const institutions = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$models$2f$Institution$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).sort({
            createdAt: -1
        }).lean();
        const enriched = await Promise.all(institutions.map(async (institution)=>{
            const [facultyCount, studentCount] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$models$2f$UserAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
...
async function POST(request) {
    ...
    if (!institutionName || !institutionCode || !adminUsername || !adminPassword) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'institutionName, institutionCode, adminUsername and adminPassword are required'
        }, {
            status: 400
        });
    }
    if (adminPassword.length < 6) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Institution admin password must be at least 6 characters'
        }, {
            status: 400
        });
    }
    if (!Number.isFinite(facultySlotLimit) || facultySlotLimit < 0 || !Number.isFinite(studentSlotLimit) || studentSlotLimit < 0) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Slot limits must be non-negative numbers'
        }, {
            status: 400
        });
    }
    try {
        ...
        const [existingCode, existingUsername] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$models$2f$Institution$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                code: institutionCode
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$models$2f$UserAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        ...
        if (existingUsername) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Institution admin username already exists'
            }, {
                status: 409
            });
        }
        const hashedPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(adminPassword, 12);
        const institutionId = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$node_modules$2f$mongoose$29$__["default"].Types.ObjectId();
        const institutionAdmin = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$models$2f$UserAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            username: adminUsername,
        ...
        const institution = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$models$2f$Institution$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            _id: institutionId,
        ...
        if (typeof error === 'object' && error !== null && 'code' in error && error.code === 11000) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Project$2f$smart$2e$hiresapien$2e$in$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Duplicate data found. Please use unique values.'
            }, {
                status: 409
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f51f0ad1._.js.map